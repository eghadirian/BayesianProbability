...
if __name__=='__main__':
    with pm.Model() as model_1:
        ...
        y1 = pm.Deterministic('y1', fun_lin(x_1, alpha_1, beta_1))
        y2 = pm.Deterministic('y2', fun_nlin_bi(x_1, x_2, alpha_2))
        y3 = pm.Deterministic('y3', fun_nlin_un(x_2, alpha_3, gamma_1))
        observed = pm.Normal('obs', tt.stack([y1, y2, y3]),\
            observed=tt.stack([y_1, y_2, y_3]))
        trace_1 = pm.sample(120000, step=pm.NUTS(), start=pm.find_MAP())
        burned_trace = trace_1[100000::2]
